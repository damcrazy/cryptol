...
?>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand" href="./Crypto.php">CRYPTOL</a>
    ...
    <script>
        function change() {
            document.getElementsByClassName("thechange")[0].innerHTML = "<div class='dropdown'><button class='dropbtn'><?php echo $_SESSION['username']; ?></button> <div class='dropdown-content'><a class='noway' href='/login/reg/login.php'><button class='logout_button' type='submit'>Log Out</button></a></div></div>"
        }
    </script>
